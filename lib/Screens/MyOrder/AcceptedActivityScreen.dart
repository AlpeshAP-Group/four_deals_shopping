...
class AcceptedOrderActivity extends StatefulWidget {
  @override
  State<AcceptedOrderActivity> createState() => AcceptedOrderActivityState();
}

class AcceptedOrderActivityState extends State<AcceptedOrderActivity> {
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<MyCurrentOrderViewModel>.reactive(
        viewModelBuilder: () => MyCurrentOrderViewModel(),
        onModelReady: (model) => {model.fetchcurrentorder("CURRENT")},
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => MyOrderDetailsPage(
                                        model.currentorder[index].salesid
                                            .toString())));
                          },
                          child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              model.currentorder[index].amount,
                                              style: TextStyle(
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              model.currentorder[index].status,
                                              style: TextStyle(
