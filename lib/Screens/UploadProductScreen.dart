...
import 'package:four_deals_shopping/Screens/UploadProductScreen2.dart';
...
class UploadProductScreen extends StatefulWidget {
  ...
  State<UploadProductScreen> createState() =>
      classUploadProductScreenStateState();
}

class classUploadProductScreenStateState extends State<UploadProductScreen> {
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadProductScreen2()));
                      },
                      child: Container(
                      ...
                      child: GestureDetector(
                          onTap: () {
                            model.postnormalads(
                                ...
                                imageFile2!,
                                [
                                  {"variantListId": 1, "variantGroupId": 2},
                                  {"variantListId": 2, "variantGroupId": 3}
                                ],
                                "Absar",
                                "22222",
                                context);
